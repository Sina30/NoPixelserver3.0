--[[
cl_bennys.lua
Functionality that handles the player for Benny's., "classic"
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("ab-bennys:attemptPurchase",cheap, type, upgradeLevel)
...
function ExitBennys()
    ...
    isPlyInBennys = false
    exports["ab-ui"]:showInteraction("Benny's", "classic")
end
...
Citizen.CreateThread(function()
    --FISHING
    exports["ab-polyzone"]:AddBoxZone("benny1", vector3(-33.99, -1052.71, 28.4), 8.0, 11.6, {
        name="benny1",
        heading=305,
        --debugPoly=true,
        minZ=27.6,
    ...
    exports["ab-polyzone"]:AddBoxZone("benny2", vector3(731.46, -1088.81, 22.17), 5.2, 11.2, {
        name="benny2",
        heading=359,
        --debugPoly=true,
        minZ=21.17,
    ...
    -- Chicken
    exports["ab-polyzone"]:AddBoxZone("benny3", vector3(110.11, 6626.67, 31.84), 7.0, 7.4, {
        name="benny3",
        heading=315,
        --debugPoly=true,
        minZ=30.04,
...
AddEventHandler('ab-polyzone:enter', function(name)
    if name == "benny1" and IsPedInAnyVehicle(PlayerPedId()) and not isPlyInBennys then
        exports["ab-ui"]:showInteraction("Benny's", "classic")
...
AddEventHandler('ab-polyzone:exit', function(name)
    if name == "benny1" then
    elseif name == "benny2" then
    elseif name == "benny3" then
    end
    exports["ab-ui"]:hideInteraction("classic")
end)

--#[Event Handlers]#--
RegisterNetEvent("ab-bennys:purchaseSuccessful")
AddEventHandler("ab-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
end)

RegisterNetEvent("ab-bennys:purchaseFailed")
AddEventHandler("ab-bennys:purchaseFailed", function()
    isPurchaseSuccessful = false
    attemptingPurchase = false
end)
--#[Export]#--

function isNearBenny()
    return NearBenny
end
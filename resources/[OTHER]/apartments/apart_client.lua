...
RegisterNetEvent('ab-weapons:stashitem')
AddEventHandler('ab-weapons:stashitem', function(itemnumber,amount,meta)
        ...
        if thename1 ~= "none" then
            ...
            TriggerServerEvent("ab-weapons:stashweapon", thename1, itemnumber, amount, 1,1,meta)
...
RegisterNetEvent('ab-weapons:giveweaponfromproperty')
AddEventHandler('ab-weapons:giveweaponfromproperty', function(result)
...
-- RegisterNetEvent('ab-weapons:checkinventory')
-- AddEventHandler('ab-weapons:checkinventory', function()
...
--             TriggerServerEvent("ab-weapons:checkinventory", thename1)
...
-- RegisterNetEvent('ab-weapons:takefromstash')
-- AddEventHandler('ab-weapons:takefromstash', function(itemname, quantity, itemtype, item, askedAmount,meta)
--     thename1 = GrabApartment(2)
--     if thename1 ~= "none" then
--         TriggerServerEvent("ab-weapons:takefromstash",itemname, quantity, itemtype, item, askedAmount,thename1,meta)
--     else
--         TriggerEvent("DoLongHudText", "Error finding property.",2)
--     end
-- end)
...
-- RegisterNetEvent('ab-weapons:stashweapon')
-- AddEventHandler('ab-weapons:stashweapon', function()
...
--             TriggerEvent("attachWeapons")
--             TriggerServerEvent("ab-weapons:stashweapon", thename1, weaponname, 1, 0,ammo)
...
AddEventHandler('AppRobberies:currentlyrobbing', function()
    if exports["ab-inventory"]:hasEnoughOfItem("lockpick",1) then
        checkRobbedStore()
        Citizen.Wait(1500)

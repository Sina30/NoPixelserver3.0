	...
	while true do
		...
		--	end
			...
			if GetDistanceBetweenCoords(PlayerPos, -1171.6, -1572.13, 4.67, true) <= 1 then						
				-- selling bud
				local smallbud = exports["ab-inventory"]:hasEnoughOfItem("smallbud",5,false)
				if smallbud then
			...
			if GetDistanceBetweenCoords(PlayerPos, 3818.36, 4441.23, 2.81, true) <= 5 then						
				...
				if JustPickedWeed or JustPackedWeed then
					...
					local wetbud = exports["ab-inventory"]:hasEnoughOfItem("wetbud",5,false)
					if wetbud then

						local finished = exports["ab-taskbar"]:taskBar(10000,"Drying Weed",false,false,playerVeh)
			...
			if GetDistanceBetweenCoords(PlayerPos, 3825.82, 4441.26, 2.81, true) <= 5 then						
				...
				if JustPickedWeed or JustDriedWeed then
					...
					local wetbud = exports["ab-inventory"]:hasEnoughOfItem("driedbud",5,false)
					if wetbud then

						local finished = exports["ab-taskbar"]:taskBar(10000,"Packing Weed",false,false,playerVeh)
						if (finished == 100) then
			...
			if GetDistanceBetweenCoords(PlayerPos, 5.87, -1601.48, 29.3, true) <= 5 then						
				...
				local smallbud = exports["ab-inventory"]:hasEnoughOfItem("freshmeat",5,false)
				if smallbud then

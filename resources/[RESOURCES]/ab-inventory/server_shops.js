...
function Mechanic() {
    var shopItems = [
        ...
        { item_id: "repairkit", id: 0, name: "Craft", information: "{}", slot: 2, amount: 5 },
        { item_id: "advrepairkit", id: 0, name: "Craft", information: "{}", slot: 3, amount: 5 },
        { item_id: "tuner", id: 0, name: "Craft", information: "{}", slot: 4, amount: 5 },
...
function ConvenienceStore() {
    var shopItems = [
        ...
        { item_id: "ciggy", id: 0, name: "Shop", information: "{}", slot: 8, amount: 50 },
        { item_id: "bandage", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
...
function HardwareStore() {
    var shopItems = [
        ...
        { item_id: "advrepairkit", id: 0, name: "Shop", information: "{}", slot: 2, amount: 5 },
        { item_id: "advlockpick", id: 0, name: "Shop", information: "{}", slot: 3, amount: 5 },
        { item_id: "lockpick", id: 0, name: "Shop", information: "{}", slot: 4, amount: 5 },
        { item_id: "binoculars", id: 0, name: "Shop", information: "{}", slot: 5, amount: 10 },
        { item_id: "3441901897", id: 0, name: "Shop", information: "{}", slot: 6, amount: 10 },   
    ];
    return JSON.stringify(shopItems);
}
...
function GunStore() {
    var shopItems = [
        ...
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
...
function FishingShopMillers() {
    var shopItems = [
        { item_id: "oxygentank", id: 0, name: "Shop", information: "{}", slot: 1, amount: 50 },
        { item_id: "fishingrod", id: 0, name: "Shop", information: "{}", slot: 2, amount: 50 },
        { item_id: "fishbait", id: 0, name: "Shop", information: "{}", slot: 3, amount: 50 },
        { item_id: "2578778090", id: 0, name: "Shop", information: "{}", slot: 4, amount: 50 },
    ];
    return JSON.stringify(shopItems);
};

...
RegisterServerEvent("ab-restart:checkRebootTime")
AddEventHandler('ab-restart:checkRebootTime', function()
...
function restartNow() SetTimeout(1000, function() TriggerEvent('ab-restart:checkRebootTime') restartNow() end) end
restartNow()

function getTax()
    local taxes = exports["ab-votesystem"]:getTaxes()

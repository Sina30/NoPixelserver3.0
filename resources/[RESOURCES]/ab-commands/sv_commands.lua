function buildCommands(job,src)
    ...
    local commandExport = exports["ab-base"]:getModule("Commands")
    exports["ab-base"]:getModule("Player"):GetUser(Lsrc)
...
RegisterServerEvent("ab-commands:buildCommands")
AddEventHandler("ab-commands:buildCommands", buildCommands)
...
AddEventHandler("ab-jobmanager:playerBecameJob", function(src, job)

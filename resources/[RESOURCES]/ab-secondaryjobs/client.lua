...
function hasDecryptGod()
    if exports["ab-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
AddEventHandler('stringGangGlobalReputations', function()
    ...
    local currenttax = exports["ab-votesystem"]:getTax()
...
function getQuantitys()
    local weed = exports["ab-inventory"]:getQuantity("weedoz")
    local cocaine = exports["ab-inventory"]:getQuantity("coke5g")
    local guns = exports["ab-inventory"]:getQuantity("riflebody")
    local launder = exports["ab-inventory"]:getQuantity("inkset")
    local stolengoods = exports["ab-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["ab-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["ab-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["ab-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
    ...
    while timer > 0 do
        ...
        if not searching then
            ...
            if IsControlJustReleased(1,Controlkey["generalUse"][1]) then
                ...
                local finished = exports["ab-taskbar"]:taskBar(25000,"Searching Thug")
...
function getQuantitysH()
    local weed = exports["ab-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["ab-inventory"]:getQuantity("coke50g")
    local guns = exports["ab-inventory"]:getQuantity("riflebodybox")
    local launder = exports["ab-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["ab-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["ab-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["ab-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["ab-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["ab-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)

ABX.Admin.DB = ABX.Admin.DB or {}

RegisterServerEvent('ab-admin:searchRequest')
AddEventHandler('ab-admin:searchRequest', function()
...
function ABX.Admin.DB.giveCar(car, cid)
...
function ABX.Admin.DB.UnbanSteamId(steamid)
...
function ABX.Admin.DB.IsPlayerBanned(target, callback)

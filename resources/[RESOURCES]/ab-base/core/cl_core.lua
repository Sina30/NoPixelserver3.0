function ABX.Core.Initialize(self)
    Citizen.CreateThread(function()
        while true do
            if NetworkIsSessionStarted() then
                TriggerEvent("ab-base:playerSessionStarted")
                TriggerServerEvent("ab-base:playerSessionStarted")
                break
            end
        end
    end)
...
AddEventHandler("ab-base:playerSessionStarted", function()
    ABX.SpawnManager:Initialize()
end)

RegisterNetEvent("ab-base:waitForExports")
AddEventHandler("ab-base:waitForExports", function()

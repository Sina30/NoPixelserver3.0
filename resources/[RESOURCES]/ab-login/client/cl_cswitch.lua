    ...
    if not waiting then
        ...
        Citizen.CreateThread(function()
            ...
            while true do
                ...
                exports["ab-base"]:getModule("Util"):DrawText("Switching character in ~b~" .. timeRemaining .. "~s~ seconds, press ~b~E~s~ to cancel.", 0, 1, 0.5, 0.8, 0.6, 255, 255, 255, 255)
        ...
        for i,v in ipairs(locations) do
            if Vdist2(pedCoords, v[1], v[2], v[3]) < 200 then
                ...
                if Vdist2(pedCoords, v[1], v[2], v[3]) < 1.0 then
                    if not waiting then exports["ab-base"]:getModule("Util"):DrawText("Press ~b~E~s~ to switch your ~b~ character", 0, 1, 0.5, 0.8, 0.6, 255, 255, 255, 255) end
                end
            end
        end
    end

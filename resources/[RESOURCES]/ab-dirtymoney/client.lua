...
RegisterNetEvent("ab-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("ab-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("ab-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("ab-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('ab-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("ab-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("ab-dirtymoney:alterDirtyMoney","ItemDrop",amount)

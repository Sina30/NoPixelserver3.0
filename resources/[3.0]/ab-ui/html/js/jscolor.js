...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.hideOnLeave = false; // whether to automatically hide the picker when user leaves its target element (e.g. upon clicking the document)
		...
		this.borderColor = 'rgba(0,0,0,0.2)' ; // CSS color
		...
		this.zIndex = 5000;
		this.container = '.color'; // where to append the color picker (BODY element by default)

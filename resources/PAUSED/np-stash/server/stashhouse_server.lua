RegisterNetEvent('ab-stash:fetchInitialState')
AddEventHandler('ab-stash:fetchInitialState', function()
	local source = source
	  TriggerClientEvent('ab-stash:setInitialState', source, Config.Stash)
end)

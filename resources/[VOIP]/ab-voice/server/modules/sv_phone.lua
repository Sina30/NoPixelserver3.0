...
RegisterServerEvent("Starting:Call")
AddEventHandler("Starting:Call", function(phoneNumber,callerID,receiverID)
    src = source
    print("STARTING CALLLLINNNNGG")
    startCall(src,phoneNumber, callerID,receiverID)
end)

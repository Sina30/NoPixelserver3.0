...
AddEventHandler('ab-voice:settingsCallback', function(cb)
	cb(Cfg)
end)

RegisterNetEvent('ab-voice:SetRadioVolume')
AddEventHandler('ab-voice:SetRadioVolume', function(passedRadioVolume)
	volume = passedRadioVolume
end)

RegisterNetEvent('ab-voice:updateRoutingBucket')
AddEventHandler('ab-voice:updateRoutingBucket', function(routingBucket)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('ab-voice:setTalkingMode', voiceMode)
	TriggerEvent("ab-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('ab-voice:mutePlayer')
AddEventHandler('ab-voice:mutePlayer', function()
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('ab-voice_enableMicClicks', val)
	end
end
...
RegisterCommand('vsync', function()
	local newGrid = getGridZone()
	debug(('[ab-voice] [vsync] Forcing zone from %s to %s and adding nearby grids.'):format(currentGrid, newGrid))
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('ab-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('ab-voice_enableMicClicks', tostring(true))
	else
	...
	print('[ab-voice] Intitalized voices.')
	intialized = true
...
RegisterCommand("grid", function()
	print(('[ab-voice] Players current grid is %s'):format(currentGrid))
end)